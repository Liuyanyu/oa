            ...
            <div class="header-right">
                <el-dropdown trigger="click">
                    ...
                    <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item><span @click="handlePassword">个人主页</span></el-dropdown-item>
                        <el-dropdown-item><span @click="handlePassword">基本资料</span></el-dropdown-item>
                        <el-dropdown-item><span @click="handlePassword">更换头像</span></el-dropdown-item>
                        <el-dropdown-item><span @click="handlePassword">更换密码</span></el-dropdown-item>
