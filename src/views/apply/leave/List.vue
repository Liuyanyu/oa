    ...
    <div>
        <div class="">
            ...
            <el-form :inline="true" :model="query">
                ...
                <el-form-item class="search">
                    <el-button type="primary" size="medium" v-on:click="getLeaveList()" icon="el-icon-search">搜索</el-button>
                </el-form-item>
                <el-form-item class="search">
        ...
        <el-table :data="list" stripe border v-loading="listLoading" style="width: 100%;">
            ...
            <el-table-column label="操作" min-width="220">
                <template slot-scope="scope">
                    <el-button size="mini" type="primary" v-if="scope.row.status != 1" @click.native="handInfo(scope.row)">查看</el-button>
...
<script>
    import {getLeaveList, deleteObj} from "../../../api/apply/leave.js";
