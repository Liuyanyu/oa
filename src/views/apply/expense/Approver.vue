    ...
    <div>
        <div class="">
            ...
            <el-form :inline="true" :model="query">
                ...
                <el-form-item class="search">
                    <el-button type="primary" size="medium" v-on:click="getExpenseApproverPage()" icon="el-icon-search">搜索</el-button>
                </el-form-item>
                <el-form-item>
        ...
        <el-table :data="list" stripe border v-loading="listLoading" style="width: 100%;" >
            ...
            <el-table-column prop="expensePrice" min-width="80" label="支出金额"></el-table-column>
